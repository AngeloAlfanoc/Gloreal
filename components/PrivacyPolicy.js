...
class PrivacyPolicy extends React.Component {
    ...
    render() {
        ...
        <div className="container py-3">
            ...
            <span>Last updated: 15/02/2020</span>

            <p>Gloreal, operates www.gloreal.be. This page informs you of our policies
            ...
            <p>Like many site operators, we collect information that your browser sends
                whenever you visit our Site ("Log Data").</p>

            <p>This Log Data may include information such as your computer's Internet
            ...
            <p>In addition, we may use third party services such as Google Analytics that
                collect, monitor and analyze this …</p>

            <p>Additionally by visiting this website, you automatically agree on the TOS
                displayed by
            ...
            <p>We may use your Personal Information to contact you with newsletters,
                marketing or promotional materials and other information that ...</p>

            <p>The Communications section is for businesses that may contact users via email
                (email newsletters) or other methods. For the full disclosure section, create
                your own Privacy Policy.</p>
            ...
            <p>Like many sites, we use "cookies" to collect information. You can instruct
            ...
            <p>This Privacy Policy is effective as of 15/02/2019 and will remain in effect
                except with respect to any changes in its provisions in the future, which will
                be in effect immediately after being posted on this page.</p>
            <p>
                ...
                and be bound by the modified Privacy Policy.</p>
            <p>
