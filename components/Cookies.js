    ...
    render() {
        ...
        return ( <>
         <div className="container py-3">
            ...
            <h2>Cookie Policy for Barbershop Gloreal</h2>

            <p>This is the Cookie Policy for Barbershop Gloreal, accessible from Gloreal.be</p>

            <p>
                <strong>What Are Cookies</strong>
            </p>

            <p>As is common practice with almost all professional websites this site uses
            ...
            <p>We use cookies for a variety of reasons detailed below. Unfortunately in most
            ...
            <p>You can prevent the setting of cookies by adjusting the settings on your
            ...
            <ul>
                ...
                <li>
                    ...
                    <p>When you submit data to through a form such as those found on contact pages
            ...
            <ul>
                ...
                <li>
                    <p>This site uses Google Analytics which is one of the most widespread and
                        ...
                        things such as how long you spend on the site and the pages that you visit so we
                        can continue to produce engaging content.</p>
                    <p>For more information on Google Analytics cookies, see the official Google
                        Analytics page.</p>
                </li>

                <li>
                    <p>Third party analytics are used to track and measure usage of this site so
                        that we can continue to produce engaging content. These cookies may track things
                        such as how long you spend on the site or pages you visit which helps us to
                        understand how we can improve the site for you.</p>
                </li>

                <li>
                    <p>From time to time we test new features and make subtle changes to the way
                        ...
                        site whilst ensuring we understand which optimisations our users appreciate the
                        most.</p>
                </li>

                <li>
                    <p>We also use social media buttons and/or plugins on this site that allow you
            ...
            <p>Hopefully that has clarified things for you and as was previously mentioned
                ...
                and the
                 <a href="https://www.privacypolicytemplate.net/"> Privacy Policy Template Generator </a>.</p>

            <p>However if you are still looking for more information then you can contact us
                through one of our preferred contact methods:</p>

            <ul>
                <li>Email: <a href="mailto:alfanoangeloc@gmail.com">alfanoangeloc@gmail.com</a>
                </li>
                <li>By visiting this link: <a href="https://www.methodsagency.be">methods</a>
                </li>
            </ul>
